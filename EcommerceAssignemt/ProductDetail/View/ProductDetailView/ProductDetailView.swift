...
public class ProductDetailView: UIView {
    ...
    var product: ProductList.ProductModel? {
        didSet {
            ...
            priceLabel.text = "\(price.priceFormatted) INR"
 
            productInfoTypeLabel.text = "Product Type: \(1)"
            productInfoColorLabel.text = "Product Category: \(category)"
            productInfoBrandLabel.text = "Product Brand: \(brand)"
